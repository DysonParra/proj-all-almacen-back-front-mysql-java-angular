/*
 * @fileoverview    {MaterialesDescripcionesViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code MaterialesDescripcionesViewModel}.
 *
 * @author Dyson Parra
...
export class MaterialesDescripcionesViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdMaterialDescripcion: number;
    public strCodigoMaterial: string;
    public strCultura: string;
     ...
     *
     */
    public newEntity(): MaterialesDescripcionesViewModel {
        return new MaterialesDescripcionesViewModel();
    }
