/*
 * @fileoverview    {UnidadMedidaViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code UnidadMedidaViewModel}.
 *
 * @author Dyson Parra
...
export class UnidadMedidaViewModel extends GenericViewModel<number> {
    ...
    public fltFactor: number;
    public fltPrecision: number;
    public fltConversion: number;
    public intDecimales: number;
     ...
     *
     */
    public newEntity(): UnidadMedidaViewModel {
