/*
 * @fileoverview    {EstadosSaldosViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code EstadosSaldosViewModel}.
 *
 * @author Dyson Parra
...
export class EstadosSaldosViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdEstadoSaldo: number;
    public strDescripcionEstadoSaldo: string;
    public strCodigoColor: string;
    public bitEstaEnReposicion: boolean;
     ...
     *
     */
    public newEntity(): EstadosSaldosViewModel {
        return new EstadosSaldosViewModel();
    }
