/*
 * @fileoverview    {TiposMaterialesViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code TiposMaterialesViewModel}.
 *
 * @author Dyson Parra
...
export class TiposMaterialesViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdTipoMaterial: number;
    public strTipoMaterial: string;
    public strDescripcionTipoMaterial: string;
     ...
     *
     */
    public newEntity(): TiposMaterialesViewModel {
        return new TiposMaterialesViewModel();
    }
