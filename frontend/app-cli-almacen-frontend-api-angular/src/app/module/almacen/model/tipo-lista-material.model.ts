/*
 * @fileoverview    {TipoListaMaterialViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code TipoListaMaterialViewModel}.
 *
 * @author Dyson Parra
...
export class TipoListaMaterialViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdTipoListaMaterial: number;
    public strNombreTipoLista: string;
    public strDescripcionLista: string;

    /**
     * TODO: Description of method {@code newEntity}.
     *
     */
    public newEntity(): TipoListaMaterialViewModel {
        return new TipoListaMaterialViewModel();
    }
