/*
 * @fileoverview    {MaterialesCaracteristicasViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code MaterialesCaracteristicasViewModel}.
 *
 * @author Dyson Parra
...
export class MaterialesCaracteristicasViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdMaterialCaracteristica: number;
    public strCodigoMaterial: string;
    public strValorCaracteristica: string;
     ...
     *
     */
    public newEntity(): MaterialesCaracteristicasViewModel {
        return new MaterialesCaracteristicasViewModel();
    }
