...
/**
 * TODO: Description of {@code ListasPreciosViewModel}.
 *
 * @author Dyson Parra
...
export class ListasPreciosViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdListaPrecio: number;
    public strNombreListaPrecios: string;
    public strDescripcionListaPrecios: string;
     ...
     *
     */
    public newEntity(): ListasPreciosViewModel {
        return new ListasPreciosViewModel();
    }
