...
/**
 * TODO: Description of {@code PlanCompraViewModel}.
 *
 * @author Dyson Parra
...
export class PlanCompraViewModel extends GenericViewModel<number> {
    ...
    public intIdGrupoProveedor: number;
    @Temporal(TemporalType.TIMESTAMP)
    public dtFechaExplosion: string;
    @Temporal(TemporalType.TIMESTAMP)
    public dtFechaCreacion: string;
    @Temporal(TemporalType.TIMESTAMP)
    public dtFechaModificacion: string;
     ...
     *
     */
    public newEntity(): PlanCompraViewModel {
        return new PlanCompraViewModel();
    }
