/*
 * @fileoverview    {TiposMovimientosViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code TiposMovimientosViewModel}.
 *
 * @author Dyson Parra
...
export class TiposMovimientosViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdTipoMovimiento: number;
    public strDescripcionTipoMovimiento: string;
    public bitSigno: boolean;
     ...
     *
     */
    public newEntity(): TiposMovimientosViewModel {
        return new TiposMovimientosViewModel();
    }
