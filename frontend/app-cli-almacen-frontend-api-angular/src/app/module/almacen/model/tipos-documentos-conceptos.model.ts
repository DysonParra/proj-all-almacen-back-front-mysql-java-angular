...
/**
 * TODO: Description of {@code TiposDocumentosConceptosViewModel}.
 *
 * @author Dyson Parra
...
export class TiposDocumentosConceptosViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdTipoDocumentoConcepto: number;
     ...
     *
     */
    public newEntity(): TiposDocumentosConceptosViewModel {
        return new TiposDocumentosConceptosViewModel();
    }
