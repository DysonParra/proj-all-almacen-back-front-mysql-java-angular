/*
 * @fileoverview    {TiposDocumentosTiposAgentesViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code TiposDocumentosTiposAgentesViewModel}.
 *
 * @author Dyson Parra
...
export class TiposDocumentosTiposAgentesViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdTipoDocumentoTipoAgente: number;
     ...
     *
     */
    public newEntity(): TiposDocumentosTiposAgentesViewModel {
        return new TiposDocumentosTiposAgentesViewModel();
    }
