...
/**
 * TODO: Description of {@code AgentesViewModel}.
 *
 * @author Dyson Parra
...
export class AgentesViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdAgente: number;
    public intIdTipoAgente: number;
    public intIdEntidad: number;
     ...
     *
     */
    public newEntity(): AgentesViewModel {
        return new AgentesViewModel();
    }
