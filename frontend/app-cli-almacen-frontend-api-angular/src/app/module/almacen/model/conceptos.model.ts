/*
 * @fileoverview    {ConceptosViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code ConceptosViewModel}.
 *
 * @author Dyson Parra
...
export class ConceptosViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdConcepto: number;
    public strDescripcionConcepto: string;
    public bitReposicion: boolean;
     ...
     *
     */
    public newEntity(): ConceptosViewModel {
        return new ConceptosViewModel();
    }
