...
/**
 * TODO: Description of {@code InterlocutorFinanzasViewModel}.
 *
 * @author Dyson Parra
...
export class InterlocutorFinanzasViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdInterlocutorFinanzas: number;
    public bitImpuesto: boolean;
    public bitSujetoRetencion: boolean;
    public strNumeroCertificadoRetencion: string;
    @Temporal(TemporalType.TIMESTAMP)
    public dtFechaVencimiento: string;
    public strNumeroAfiliacionSeguridad: string;
     ...
     *
     */
    public newEntity(): InterlocutorFinanzasViewModel {
        return new InterlocutorFinanzasViewModel();
    }
