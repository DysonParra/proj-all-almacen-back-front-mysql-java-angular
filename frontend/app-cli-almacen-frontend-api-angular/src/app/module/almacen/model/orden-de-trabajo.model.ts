/*
 * @fileoverview    {OrdenDeTrabajoViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code OrdenDeTrabajoViewModel}.
 *
 * @author Dyson Parra
...
export class OrdenDeTrabajoViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdOrdenTrabajo: number;
    public intIdOperacion: number;
    public intIdCentroTrabajo: number;
    public intIdEstadoOT: number;
     ...
     *
     */
    public newEntity(): OrdenDeTrabajoViewModel {
        return new OrdenDeTrabajoViewModel();
    }
