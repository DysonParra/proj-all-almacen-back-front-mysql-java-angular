...
/**
 * TODO: Description of {@code MmTmcdDescripcionesViewModel}.
 *
 * @author Dyson Parra
...
export class MmTmcdDescripcionesViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdMmTmcdDescripciones: number;
     ...
     *
     */
    public newEntity(): MmTmcdDescripcionesViewModel {
        return new MmTmcdDescripcionesViewModel();
    }
