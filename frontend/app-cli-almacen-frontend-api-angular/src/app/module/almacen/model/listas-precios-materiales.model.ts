/*
 * @fileoverview    {ListasPreciosMaterialesViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code ListasPreciosMaterialesViewModel}.
 *
 * @author Dyson Parra
...
export class ListasPreciosMaterialesViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intId: number;
    @NotNull
    public intIdMateriales: number;
    @NotNull
    public intIdListasPrecios: number;

    /**
     * TODO: Description of method {@code newEntity}.
     *
     */
    public newEntity(): ListasPreciosMaterialesViewModel {
        return new ListasPreciosMaterialesViewModel();
    }
