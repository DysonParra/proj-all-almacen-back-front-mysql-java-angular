/*
 * @fileoverview    {TipoInterlocutorComercialViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code TipoInterlocutorComercialViewModel}.
 *
 * @author Dyson Parra
...
export class TipoInterlocutorComercialViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdTipoInterlocutorComercial: number;
    public strTipoInterlocutor: string;
    public strDescripcionTipoInterlocutor: string;
     ...
     *
     */
    public newEntity(): TipoInterlocutorComercialViewModel {
        return new TipoInterlocutorComercialViewModel();
    }
