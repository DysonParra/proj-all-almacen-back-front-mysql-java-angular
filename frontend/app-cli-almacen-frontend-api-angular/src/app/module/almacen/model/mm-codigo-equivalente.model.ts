/*
 * @fileoverview    {MmCodigoEquivalenteViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code MmCodigoEquivalenteViewModel}.
 *
 * @author Dyson Parra
...
export class MmCodigoEquivalenteViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdMmCodigoEquivalente: number;
    public strCodigoMaterial: string;
    public strTipoCodigoEquivalente: string;
    public strValorCodigoEquivalente: string;
     ...
     *
     */
    public newEntity(): MmCodigoEquivalenteViewModel {
        return new MmCodigoEquivalenteViewModel();
    }
