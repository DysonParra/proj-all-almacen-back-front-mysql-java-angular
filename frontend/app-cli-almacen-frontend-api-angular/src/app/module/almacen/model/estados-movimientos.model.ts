/*
 * @fileoverview    {EstadosMovimientosViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code EstadosMovimientosViewModel}.
 *
 * @author Dyson Parra
...
export class EstadosMovimientosViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdEstadoMovimiento: number;
    public strDescripcionEstadoMovimiento: string;
     ...
     *
     */
    public newEntity(): EstadosMovimientosViewModel {
        return new EstadosMovimientosViewModel();
    }
