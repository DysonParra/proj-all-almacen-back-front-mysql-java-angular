/*
 * @fileoverview    {SociedadViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code SociedadViewModel}.
 *
 * @author Dyson Parra
...
export class SociedadViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdSociedad: number;
    public strCodigoSociedad: string;
    public strNombreSociedad: string;
    public strDescripcionSociedad: string;
     ...
     *
     */
    public newEntity(): SociedadViewModel {
        return new SociedadViewModel();
    }
