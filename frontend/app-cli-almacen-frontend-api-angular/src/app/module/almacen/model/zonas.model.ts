...
/**
 * TODO: Description of {@code ZonasViewModel}.
 *
 * @author Dyson Parra
...
export class ZonasViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public strCodigoZona: string;
    public intIdBodega: number;
    public strDescripcionZona: string;
    public bitTransitoDirecto: boolean;
    public bitPicking: boolean;
    public bitUbicacion: boolean;
    public bitDespacho: boolean;
    public bitRecepcion: boolean;
     ...
     *
     */
    public newEntity(): ZonasViewModel {
