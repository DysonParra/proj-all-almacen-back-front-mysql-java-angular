/*
 * @fileoverview    {TipoInterlocutorComercialMapping} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code TipoInterlocutorComercialMapping}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface TipoInterlocutorComercialMapping extends GenericMapping<TipoInterlocutorComercialDTO, TipoInterlocutorComercial> {
    ...
    @Mapping(source = "intIdTipoInterlocutorComercial", target = "intIdTipoInterlocutorComercial")
    @Override
    public TipoInterlocutorComercialDTO obtenerDto(TipoInterlocutorComercial entity);
