/*
 * @fileoverview    {MaterialesCaracteristicasServiceImpl} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code MaterialesCaracteristicasServiceImpl}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public class MaterialesCaracteristicasServiceImpl implements MaterialesCaracteristicasService {
    ...
    public Page<MaterialesCaracteristicasDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo MaterialesCaracteristicas con paginacion");
    ...
    public MaterialesCaracteristicasDTO saveUpdate(MaterialesCaracteristicasDTO entityDTO) throws Exception {
        ...
        MaterialesCaracteristicasDTO actualEntity = entityMapping.obtenerDto(entity);
        return actualEntity;
    }
