/*
 * @fileoverview    {LocalizacionesRepository} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code LocalizacionesRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface LocalizacionesRepository extends JpaRepository<Localizaciones, Long> {
     ...
     */
    public List<Localizaciones> findByIntIdLocalizacion(Long id);
