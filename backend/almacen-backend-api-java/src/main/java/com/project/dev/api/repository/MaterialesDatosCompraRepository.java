/*
 * @fileoverview    {MaterialesDatosCompraRepository} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code MaterialesDatosCompraRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface MaterialesDatosCompraRepository extends JpaRepository<MaterialesDatosCompra, Long> {
     ...
     */
    public List<MaterialesDatosCompra> findByIntIdMaterialDatoCompra(Long id);
