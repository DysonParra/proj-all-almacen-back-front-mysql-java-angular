/*
 * @fileoverview    {MaterialesDescripcionesMapping} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code MaterialesDescripcionesMapping}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface MaterialesDescripcionesMapping extends GenericMapping<MaterialesDescripcionesDTO, MaterialesDescripciones> {
    ...
    @Mapping(source = "intIdMaterialDescripcion", target = "intIdMaterialDescripcion")
    @Override
    public MaterialesDescripcionesDTO obtenerDto(MaterialesDescripciones entity);
