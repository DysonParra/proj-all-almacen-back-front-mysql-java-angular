/*
 * @fileoverview    {EstadosMovimientosServiceImpl} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
public class EstadosMovimientosServiceImpl implements EstadosMovimientosService {
    ...
    public EstadosMovimientosDTO saveUpdate(EstadosMovimientosDTO entityDTO) throws Exception {
        ...
        EstadosMovimientosDTO actualEntity = entityMapping.obtenerDto(entity);
        return actualEntity;
    }
