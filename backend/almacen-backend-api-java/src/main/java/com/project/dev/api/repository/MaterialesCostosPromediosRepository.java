/*
 * @fileoverview    {MaterialesCostosPromediosRepository} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code MaterialesCostosPromediosRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface MaterialesCostosPromediosRepository extends JpaRepository<MaterialesCostosPromedios, Long> {
     ...
     */
    public List<MaterialesCostosPromedios> findByIntIdMaterialCostoPromedio(Long id);
