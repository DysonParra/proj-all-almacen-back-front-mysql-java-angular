/*
 * @fileoverview    {MaterialesDescripcionesServiceImpl} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code MaterialesDescripcionesServiceImpl}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public class MaterialesDescripcionesServiceImpl implements MaterialesDescripcionesService {
    ...
    public Page<MaterialesDescripcionesDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo MaterialesDescripciones con paginacion");
    ...
    public MaterialesDescripcionesDTO saveUpdate(MaterialesDescripcionesDTO entityDTO) throws Exception {
        ...
        MaterialesDescripcionesDTO actualEntity = entityMapping.obtenerDto(entity);
        return actualEntity;
    }
