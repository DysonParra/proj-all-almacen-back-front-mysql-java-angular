/*
 * @fileoverview    {TiposDocumentosRepository} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code TiposDocumentosRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface TiposDocumentosRepository extends JpaRepository<TiposDocumentos, Long> {
     ...
     */
    public List<TiposDocumentos> findByIntIdTipoDocumento(Long id);
