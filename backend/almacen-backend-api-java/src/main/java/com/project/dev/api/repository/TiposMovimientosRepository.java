...
/**
 * TODO: Definición de {@code TiposMovimientosRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
@org.springframework.stereotype.Repository
public interface TiposMovimientosRepository extends JpaRepository<TiposMovimientos, Long> {
     ...
     */
    public List<TiposMovimientos> findByIntIdTipoMovimiento(Long id);
    ...
    @Query("SELECT m FROM TiposMovimientos m WHERE m.intIdTipoMovimiento LIKE CONCAT('%', :strSearch, '%')")
    public List<TiposMovimientos> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM TiposMovimientos m WHERE m.intIdTipoMovimiento LIKE CONCAT('%', :strSearch, '%')")
    public Page<TiposMovimientos> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
