...
public class BodegasRest {
    ...
    public ResponseEntity<List<BodegasDTO>> getAllEntitiesPaged(Pageable pageable) {
    ...
    public ResponseEntity<List<BodegasDTO>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
