/*
 * @fileoverview    {ListaDeMaterialesRepository} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code ListaDeMaterialesRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface ListaDeMaterialesRepository extends JpaRepository<ListaDeMateriales, Long> {
     ...
     */
    public List<ListaDeMateriales> findByIntIdListaMaterial(Long id);
