/*
 * @fileoverview    {RemisionesServiceImpl} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code RemisionesServiceImpl}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public class RemisionesServiceImpl implements RemisionesService {
    ...
    public Page<RemisionesDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo Remisiones con paginacion");
    ...
    public RemisionesDTO saveUpdate(RemisionesDTO entityDTO) throws Exception {
        ...
        RemisionesDTO actualEntity = entityMapping.obtenerDto(entity);
        return actualEntity;
    }
