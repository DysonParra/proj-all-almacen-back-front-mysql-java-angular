/*
 * @fileoverview    {EstadosRemisionesRepository} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code EstadosRemisionesRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface EstadosRemisionesRepository extends JpaRepository<EstadosRemisiones, Long> {
     ...
     */
    public List<EstadosRemisiones> findByIntIdEstadoRemision(Long id);
