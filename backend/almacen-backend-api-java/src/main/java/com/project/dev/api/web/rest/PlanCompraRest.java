...
public class PlanCompraRest {
    ...
    private final PlanCompraService entityService;
     ...
     */
    public PlanCompraRest(PlanCompraService entityService,
    ...
    public ResponseEntity<List<PlanCompraDTO>> getAllEntitiesPaged(Pageable pageable) {
    ...
    @GetMapping("/PlanCompra/{query}/pages")
    public ResponseEntity<List<PlanCompraDTO>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/PlanCompra/{query}/pages/" + query);
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
