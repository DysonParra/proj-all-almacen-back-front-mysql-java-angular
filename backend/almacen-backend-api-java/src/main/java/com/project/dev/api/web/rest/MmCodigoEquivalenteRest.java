/*
 * @fileoverview    {MmCodigoEquivalenteRest} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code MmCodigoEquivalenteRest}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
@Api(value = "MmCodigoEquivalente API")
public class MmCodigoEquivalenteRest {
    ...
    public CollectionModel<EntityModel<MmCodigoEquivalenteDTO>> getAllEntities() {
        ...
        try {
            ...
            CollectionModel<EntityModel<MmCodigoEquivalenteDTO>> entitiesCollection = new CollectionModel<>(entities);
            entitiesCollection.add(linkTo(methodOn(MmCodigoEquivalenteRest.class).getAllEntities()).withSelfRel());
    ...
    public ResponseEntity<List<MmCodigoEquivalenteDTO>> getAllEntitiesPaged(Pageable pageable) {
    ...
    @GetMapping("/MmCodigoEquivalente/{query}/pages")
    public ResponseEntity<List<MmCodigoEquivalenteDTO>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/MmCodigoEquivalente/{query}/pages/" + query);
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
