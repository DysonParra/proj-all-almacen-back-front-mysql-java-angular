/*
 * @fileoverview    {ListasPreciosMaterialesRest} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code ListasPreciosMaterialesRest}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
@Api(value = "ListasPreciosMateriales API")
public class ListasPreciosMaterialesRest {
    ...
    public CollectionModel<EntityModel<ListasPreciosMaterialesDTO>> getAllEntities() {
        ...
        try {
            ...
            CollectionModel<EntityModel<ListasPreciosMaterialesDTO>> entitiesCollection = new CollectionModel<>(entities);
            entitiesCollection.add(linkTo(methodOn(ListasPreciosMaterialesRest.class).getAllEntities()).withSelfRel());
    ...
    public ResponseEntity<List<ListasPreciosMaterialesDTO>> getAllEntitiesPaged(Pageable pageable) {
    ...
    @GetMapping("/ListasPreciosMateriales/{query}/pages")
    public ResponseEntity<List<ListasPreciosMaterialesDTO>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/ListasPreciosMateriales/{query}/pages/" + query);
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
