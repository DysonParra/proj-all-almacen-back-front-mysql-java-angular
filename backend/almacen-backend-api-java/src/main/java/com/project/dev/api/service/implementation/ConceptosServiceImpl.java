/*
 * @fileoverview    {ConceptosServiceImpl} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code ConceptosServiceImpl}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public class ConceptosServiceImpl implements ConceptosService {
    ...
    public Page<ConceptosDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo Conceptos con paginacion");
    ...
    public ConceptosDTO saveUpdate(ConceptosDTO entityDTO) throws Exception {
        ...
        ConceptosDTO actualEntity = entityMapping.obtenerDto(entity);
        return actualEntity;
    }
