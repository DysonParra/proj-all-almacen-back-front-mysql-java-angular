/*
 * @fileoverview    {TiposDocumentosConceptosRest} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
@Api(value = "TiposDocumentosConceptos API")
public class TiposDocumentosConceptosRest {
    ...
    public CollectionModel<EntityModel<TiposDocumentosConceptosDTO>> getAllEntities() {
        ...
        try {
            ...
            CollectionModel<EntityModel<TiposDocumentosConceptosDTO>> entitiesCollection = new CollectionModel<>(entities);
            entitiesCollection.add(linkTo(methodOn(TiposDocumentosConceptosRest.class).getAllEntities()).withSelfRel());
    ...
    public ResponseEntity<List<TiposDocumentosConceptosDTO>> getAllEntitiesPaged(Pageable pageable) {
