/*
 * @fileoverview    {RemisionesVentaMaterialesRepository} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code RemisionesVentaMaterialesRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface RemisionesVentaMaterialesRepository extends JpaRepository<RemisionesVentaMateriales, Long> {
     ...
     */
    public List<RemisionesVentaMateriales> findByIntIdRemisionVentaMaterial(Long id);
