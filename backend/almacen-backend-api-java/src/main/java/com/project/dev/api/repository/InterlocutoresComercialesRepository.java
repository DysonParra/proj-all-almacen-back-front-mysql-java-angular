/*
 * @fileoverview    {InterlocutoresComercialesRepository} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code InterlocutoresComercialesRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface InterlocutoresComercialesRepository extends JpaRepository<InterlocutoresComerciales, Long> {
     ...
     */
    public List<InterlocutoresComerciales> findByIntIdInterlocutorComercial(Long id);
