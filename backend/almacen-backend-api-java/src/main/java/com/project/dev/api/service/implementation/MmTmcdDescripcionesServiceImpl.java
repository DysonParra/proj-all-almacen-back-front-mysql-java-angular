/*
 * @fileoverview    {MmTmcdDescripcionesServiceImpl} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code MmTmcdDescripcionesServiceImpl}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public class MmTmcdDescripcionesServiceImpl implements MmTmcdDescripcionesService {
    ...
    public Page<MmTmcdDescripcionesDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo MmTmcdDescripciones con paginacion");
    ...
    public MmTmcdDescripcionesDTO saveUpdate(MmTmcdDescripcionesDTO entityDTO) throws Exception {
        ...
        MmTmcdDescripcionesDTO actualEntity = entityMapping.obtenerDto(entity);
        return actualEntity;
    }
