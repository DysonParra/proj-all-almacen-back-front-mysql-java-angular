/*
 * @fileoverview    {ListaDeMaterialesServiceImpl} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
public class ListaDeMaterialesServiceImpl implements ListaDeMaterialesService {
    ...
    public ListaDeMaterialesDTO saveUpdate(ListaDeMaterialesDTO entityDTO) throws Exception {
        ...
        ListaDeMaterialesDTO actualEntity = entityMapping.obtenerDto(entity);
        return actualEntity;
    }
