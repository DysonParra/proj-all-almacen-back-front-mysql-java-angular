...
/**
 * TODO: Definición de {@code MmCodigoEquivalenteServiceImpl}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public class MmCodigoEquivalenteServiceImpl implements MmCodigoEquivalenteService {
    ...
    public Page<MmCodigoEquivalenteDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo MmCodigoEquivalente con paginacion");
    ...
    public MmCodigoEquivalenteDTO saveUpdate(MmCodigoEquivalenteDTO entityDTO) throws Exception {
        ...
        MmCodigoEquivalenteDTO actualEntity = entityMapping.obtenerDto(entity);
        return actualEntity;
    }
