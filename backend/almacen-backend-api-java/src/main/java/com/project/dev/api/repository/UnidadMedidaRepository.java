...
public interface UnidadMedidaRepository extends JpaRepository<UnidadMedida, Long> {
     ...
     */
    public List<UnidadMedida> findByIntIdUnidadMedida(Long id);
    ...
    @Query("SELECT m FROM UnidadMedida m WHERE m.intIdUnidadMedida LIKE CONCAT('%', :strSearch, '%')")
    public List<UnidadMedida> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM UnidadMedida m WHERE m.intIdUnidadMedida LIKE CONCAT('%', :strSearch, '%')")
    public Page<UnidadMedida> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
