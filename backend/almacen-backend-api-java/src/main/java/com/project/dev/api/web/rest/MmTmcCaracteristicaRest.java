/*
 * @fileoverview    {MmTmcCaracteristicaRest} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code MmTmcCaracteristicaRest}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
@Api(value = "MmTmcCaracteristica API")
public class MmTmcCaracteristicaRest {
    ...
    public CollectionModel<EntityModel<MmTmcCaracteristicaDTO>> getAllEntities() {
        ...
        try {
            ...
            CollectionModel<EntityModel<MmTmcCaracteristicaDTO>> entitiesCollection = new CollectionModel<>(entities);
            entitiesCollection.add(linkTo(methodOn(MmTmcCaracteristicaRest.class).getAllEntities()).withSelfRel());
    ...
    public ResponseEntity<List<MmTmcCaracteristicaDTO>> getAllEntitiesPaged(Pageable pageable) {
