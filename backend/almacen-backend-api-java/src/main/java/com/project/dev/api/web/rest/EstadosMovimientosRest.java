...
public class EstadosMovimientosRest {
    ...
    @GetMapping("/EstadosMovimientos/{query}/pages")
    public ResponseEntity<List<EstadosMovimientosDTO>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/EstadosMovimientos/{query}/pages/" + query);
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
