...
/**
 * TODO: Definición de {@code CotizacionRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface CotizacionRepository extends JpaRepository<Cotizacion, Integer> {
     ...
     */
    public List<Cotizacion> findByIntIdCotizacion(Integer id);
    ...
    @Query("SELECT m FROM Cotizacion m WHERE m.intIdCotizacion LIKE CONCAT('%', :strSearch, '%')")
    public List<Cotizacion> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM Cotizacion m WHERE m.intIdCotizacion LIKE CONCAT('%', :strSearch, '%')")
    public Page<Cotizacion> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
