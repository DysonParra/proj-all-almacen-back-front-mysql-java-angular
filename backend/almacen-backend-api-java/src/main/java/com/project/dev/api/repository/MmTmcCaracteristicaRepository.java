/*
 * @fileoverview    {MmTmcCaracteristicaRepository} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
public interface MmTmcCaracteristicaRepository extends JpaRepository<MmTmcCaracteristica, Long> {
     ...
     */
    public List<MmTmcCaracteristica> findByIntIdMmTmcCaracteristica(Long id);
