/*
 * @fileoverview    {RemisionesComprasRest} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code RemisionesComprasRest}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
@Api(value = "RemisionesCompras API")
public class RemisionesComprasRest {
    ...
    public CollectionModel<EntityModel<RemisionesComprasDTO>> getAllEntities() {
        ...
        try {
            ...
            CollectionModel<EntityModel<RemisionesComprasDTO>> entitiesCollection = new CollectionModel<>(entities);
            entitiesCollection.add(linkTo(methodOn(RemisionesComprasRest.class).getAllEntities()).withSelfRel());
    ...
    public ResponseEntity<List<RemisionesComprasDTO>> getAllEntitiesPaged(Pageable pageable) {
    ...
    @GetMapping("/RemisionesCompras/{query}/pages")
    public ResponseEntity<List<RemisionesComprasDTO>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/RemisionesCompras/{query}/pages/" + query);
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
