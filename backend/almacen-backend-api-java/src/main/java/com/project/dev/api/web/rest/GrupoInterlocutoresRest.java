/*
 * @fileoverview    {GrupoInterlocutoresRest} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code GrupoInterlocutoresRest}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public class GrupoInterlocutoresRest {
    ...
    private final GrupoInterlocutoresService entityService;
     ...
     */
    public GrupoInterlocutoresRest(GrupoInterlocutoresService entityService,
    ...
    @GetMapping("/GrupoInterlocutores")
    ...
    @GetMapping("/GrupoInterlocutores/pages")
    public ResponseEntity<List<GrupoInterlocutoresDTO>> getAllEntitiesPaged(Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/GrupoInterlocutores/pages");
    ...
    @PostMapping("/GrupoInterlocutores")
    ...
    @PutMapping("/GrupoInterlocutores/{id}")
    ...
    @GetMapping("/GrupoInterlocutores/{id}")
    ...
    @DeleteMapping("/GrupoInterlocutores/{id}")
    ...
    @GetMapping("/GrupoInterlocutores/search/{query}")
