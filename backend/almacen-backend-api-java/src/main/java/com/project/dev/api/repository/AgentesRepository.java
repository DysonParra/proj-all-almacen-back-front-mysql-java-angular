/*
 * @fileoverview    {AgentesRepository} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code AgentesRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface AgentesRepository extends JpaRepository<Agentes, Long> {
     ...
     */
    public List<Agentes> findByIntIdAgente(Long id);
