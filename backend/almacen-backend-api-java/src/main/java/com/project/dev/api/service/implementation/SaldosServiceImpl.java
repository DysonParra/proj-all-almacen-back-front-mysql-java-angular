/*
 * @fileoverview    {SaldosServiceImpl} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code SaldosServiceImpl}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public class SaldosServiceImpl implements SaldosService {
    ...
    public Page<SaldosDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo Saldos con paginacion");
    ...
    public SaldosDTO saveUpdate(SaldosDTO entityDTO) throws Exception {
        ...
        SaldosDTO actualEntity = entityMapping.obtenerDto(entity);
        return actualEntity;
    }
