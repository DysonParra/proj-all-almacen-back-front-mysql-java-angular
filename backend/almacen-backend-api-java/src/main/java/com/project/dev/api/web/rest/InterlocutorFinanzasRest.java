...
public class InterlocutorFinanzasRest {
    ...
    @GetMapping("/InterlocutorFinanzas/{query}/pages")
    public ResponseEntity<List<InterlocutorFinanzasDTO>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/InterlocutorFinanzas/{query}/pages/" + query);
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
