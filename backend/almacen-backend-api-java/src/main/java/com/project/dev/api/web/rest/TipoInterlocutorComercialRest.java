/*
 * @fileoverview    {TipoInterlocutorComercialRest} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code TipoInterlocutorComercialRest}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
@Api(value = "TipoInterlocutorComercial API")
public class TipoInterlocutorComercialRest {
    ...
    public CollectionModel<EntityModel<TipoInterlocutorComercialDTO>> getAllEntities() {
        ...
        try {
            ...
            CollectionModel<EntityModel<TipoInterlocutorComercialDTO>> entitiesCollection = new CollectionModel<>(entities);
            entitiesCollection.add(linkTo(methodOn(TipoInterlocutorComercialRest.class).getAllEntities()).withSelfRel());
    ...
    public ResponseEntity<List<TipoInterlocutorComercialDTO>> getAllEntitiesPaged(Pageable pageable) {
    ...
    @GetMapping("/TipoInterlocutorComercial/{query}/pages")
    public ResponseEntity<List<TipoInterlocutorComercialDTO>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/TipoInterlocutorComercial/{query}/pages/" + query);
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
