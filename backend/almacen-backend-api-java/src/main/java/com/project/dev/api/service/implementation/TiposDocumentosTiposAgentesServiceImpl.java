/*
 * @fileoverview    {TiposDocumentosTiposAgentesServiceImpl} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code TiposDocumentosTiposAgentesServiceImpl}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public class TiposDocumentosTiposAgentesServiceImpl implements TiposDocumentosTiposAgentesService {
    ...
    public TiposDocumentosTiposAgentesDTO saveUpdate(TiposDocumentosTiposAgentesDTO entityDTO) throws Exception {
        ...
        TiposDocumentosTiposAgentesDTO actualEntity = entityMapping.obtenerDto(entity);
        return actualEntity;
    }
