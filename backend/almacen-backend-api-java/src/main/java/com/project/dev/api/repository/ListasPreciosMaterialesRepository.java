...
/**
 * TODO: Definición de {@code ListasPreciosMaterialesRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
@org.springframework.stereotype.Repository
public interface ListasPreciosMaterialesRepository extends JpaRepository<ListasPreciosMateriales, Long> {
     ...
     */
    public List<ListasPreciosMateriales> findByIntId(Long id);
    ...
    @Query("SELECT m FROM ListasPreciosMateriales m WHERE m.intId LIKE CONCAT('%', :strSearch, '%')")
    public List<ListasPreciosMateriales> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM ListasPreciosMateriales m WHERE m.intId LIKE CONCAT('%', :strSearch, '%')")
    public Page<ListasPreciosMateriales> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
