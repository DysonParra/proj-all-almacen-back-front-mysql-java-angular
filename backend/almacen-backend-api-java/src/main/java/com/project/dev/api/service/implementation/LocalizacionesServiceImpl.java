/*
 * @fileoverview    {LocalizacionesServiceImpl} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code LocalizacionesServiceImpl}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public class LocalizacionesServiceImpl implements LocalizacionesService {
    ...
    public LocalizacionesDTO saveUpdate(LocalizacionesDTO entityDTO) throws Exception {
        ...
        LocalizacionesDTO actualEntity = entityMapping.obtenerDto(entity);
        return actualEntity;
    }
