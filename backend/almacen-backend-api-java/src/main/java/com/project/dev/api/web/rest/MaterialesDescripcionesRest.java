...
/**
 * TODO: Definición de {@code MaterialesDescripcionesRest}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public class MaterialesDescripcionesRest {
    ...
    private final MaterialesDescripcionesService entityService;
     ...
     */
    public MaterialesDescripcionesRest(MaterialesDescripcionesService entityService,
    ...
    public ResponseEntity<List<MaterialesDescripcionesDTO>> getAllEntitiesPaged(Pageable pageable) {
    ...
    @GetMapping("/MaterialesDescripciones/{query}/pages")
    public ResponseEntity<List<MaterialesDescripcionesDTO>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/MaterialesDescripciones/{query}/pages/" + query);
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
