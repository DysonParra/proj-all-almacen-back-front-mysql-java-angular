/*
 * @fileoverview    {InterlocutorFinanzasMapping} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code InterlocutorFinanzasMapping}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface InterlocutorFinanzasMapping extends GenericMapping<InterlocutorFinanzasDTO, InterlocutorFinanzas> {
    ...
    @Mapping(source = "intIdInterlocutorFinanzas", target = "intIdInterlocutorFinanzas")
    @Override
    public InterlocutorFinanzasDTO obtenerDto(InterlocutorFinanzas entity);
