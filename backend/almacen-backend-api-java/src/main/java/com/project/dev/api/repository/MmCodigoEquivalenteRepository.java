...
/**
 * TODO: Definición de {@code MmCodigoEquivalenteRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
@org.springframework.stereotype.Repository
public interface MmCodigoEquivalenteRepository extends JpaRepository<MmCodigoEquivalente, Long> {
     ...
     */
    public List<MmCodigoEquivalente> findByIntIdMmCodigoEquivalente(Long id);
    ...
    @Query("SELECT m FROM MmCodigoEquivalente m WHERE m.intIdMmCodigoEquivalente LIKE CONCAT('%', :strSearch, '%')")
    public List<MmCodigoEquivalente> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM MmCodigoEquivalente m WHERE m.intIdMmCodigoEquivalente LIKE CONCAT('%', :strSearch, '%')")
    public Page<MmCodigoEquivalente> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
