/*
 * @fileoverview    {MaterialesDatosCompraMapping} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code MaterialesDatosCompraMapping}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface MaterialesDatosCompraMapping extends GenericMapping<MaterialesDatosCompraDTO, MaterialesDatosCompra> {
    ...
    @Mapping(source = "intIdMaterialDatoCompra", target = "intIdMaterialDatoCompra")
    @Override
    public MaterialesDatosCompraDTO obtenerDto(MaterialesDatosCompra entity);
