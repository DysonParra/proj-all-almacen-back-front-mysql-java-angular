/*
 * @fileoverview    {OrdenDeTrabajoServiceImpl} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code OrdenDeTrabajoServiceImpl}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public class OrdenDeTrabajoServiceImpl implements OrdenDeTrabajoService {
    ...
    public OrdenDeTrabajoDTO saveUpdate(OrdenDeTrabajoDTO entityDTO) throws Exception {
        ...
        OrdenDeTrabajoDTO actualEntity = entityMapping.obtenerDto(entity);
        return actualEntity;
    }
