/*
 * @fileoverview    {TipoListaMaterialRest} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code TipoListaMaterialRest}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
@Api(value = "TipoListaMaterial API")
public class TipoListaMaterialRest {
    ...
    public CollectionModel<EntityModel<TipoListaMaterialDTO>> getAllEntities() {
        ...
        try {
            ...
            CollectionModel<EntityModel<TipoListaMaterialDTO>> entitiesCollection = new CollectionModel<>(entities);
            entitiesCollection.add(linkTo(methodOn(TipoListaMaterialRest.class).getAllEntities()).withSelfRel());
    ...
    public ResponseEntity<List<TipoListaMaterialDTO>> getAllEntitiesPaged(Pageable pageable) {
    ...
    @GetMapping("/TipoListaMaterial/{query}/pages")
    public ResponseEntity<List<TipoListaMaterialDTO>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/TipoListaMaterial/{query}/pages/" + query);
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
