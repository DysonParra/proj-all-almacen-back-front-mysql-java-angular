/*
 * @fileoverview    {InterlocutoresCondicionPagoRest} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
public class InterlocutoresCondicionPagoRest {
    ...
    private final InterlocutoresCondicionPagoService entityService;
     ...
     */
    public InterlocutoresCondicionPagoRest(InterlocutoresCondicionPagoService entityService,
    ...
    public ResponseEntity<List<InterlocutoresCondicionPagoDTO>> getAllEntitiesPaged(Pageable pageable) {
    ...
    @GetMapping("/InterlocutoresCondicionPago/{query}/pages")
    public ResponseEntity<List<InterlocutoresCondicionPagoDTO>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/InterlocutoresCondicionPago/{query}/pages/" + query);
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
