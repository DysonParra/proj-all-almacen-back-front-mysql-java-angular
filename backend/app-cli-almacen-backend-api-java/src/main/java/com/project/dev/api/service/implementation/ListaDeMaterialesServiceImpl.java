/*
 * @overview        {ListaDeMaterialesServiceImpl}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code ListaDeMaterialesServiceImpl}.
 *
 * @author Dyson Parra
...
public class ListaDeMaterialesServiceImpl implements GenericService<ListaDeMaterialesDTO> {
    ...
    public Page<ListaDeMaterialesDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo ListaDeMateriales con paginación");
    ...
    public ListaDeMaterialesDTO saveUpdate(ListaDeMaterialesDTO entityDTO) throws Exception {
        ...
        ListaDeMaterialesDTO dto = entityMapping.getDto(entity);
        return dto;
    }
