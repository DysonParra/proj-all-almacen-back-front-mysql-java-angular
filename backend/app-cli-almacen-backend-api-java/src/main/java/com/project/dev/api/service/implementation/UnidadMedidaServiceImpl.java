/*
 * @overview        {UnidadMedidaServiceImpl}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code UnidadMedidaServiceImpl}.
 *
 * @author Dyson Parra
...
public class UnidadMedidaServiceImpl implements GenericService<UnidadMedidaDTO> {
    ...
    public Page<UnidadMedidaDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo UnidadMedida con paginación");
    ...
    public UnidadMedidaDTO saveUpdate(UnidadMedidaDTO entityDTO) throws Exception {
        ...
        UnidadMedidaDTO dto = entityMapping.getDto(entity);
        return dto;
    }
