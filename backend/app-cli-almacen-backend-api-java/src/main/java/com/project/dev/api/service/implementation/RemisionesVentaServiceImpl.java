/*
 * @overview        {RemisionesVentaServiceImpl}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code RemisionesVentaServiceImpl}.
 *
 * @author Dyson Parra
...
public class RemisionesVentaServiceImpl implements GenericService<RemisionesVentaDTO> {
    ...
    public Page<RemisionesVentaDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo RemisionesVenta con paginación");
    ...
    public RemisionesVentaDTO saveUpdate(RemisionesVentaDTO entityDTO) throws Exception {
        ...
        RemisionesVentaDTO dto = entityMapping.getDto(entity);
        return dto;
    }
