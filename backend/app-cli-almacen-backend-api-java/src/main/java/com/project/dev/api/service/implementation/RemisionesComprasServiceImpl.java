/*
 * @overview        {RemisionesComprasServiceImpl}
 *
 * @version         2.0
 *
...
public class RemisionesComprasServiceImpl implements GenericService<RemisionesComprasDTO> {
    ...
    public Page<RemisionesComprasDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo RemisionesCompras con paginación");
    ...
    public RemisionesComprasDTO saveUpdate(RemisionesComprasDTO entityDTO) throws Exception {
        ...
        RemisionesComprasDTO dto = entityMapping.getDto(entity);
        return dto;
    }
