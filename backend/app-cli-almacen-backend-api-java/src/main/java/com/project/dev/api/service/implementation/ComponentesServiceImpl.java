/*
 * @overview        {ComponentesServiceImpl}
 *
 * @version         2.0
 *
...
import com.project.dev.api.repository.ComponentesRepository;
import com.project.dev.api.service.GenericService;
import com.project.dev.api.service.exception.EntityNotFoundException;
import com.project.dev.api.service.mapping.ComponentesMapping;
...
/**
 * TODO: Description of {@code ComponentesServiceImpl}.
 *
 * @author Dyson Parra
...
public class ComponentesServiceImpl implements GenericService<ComponentesDTO> {

    private final Logger log = LoggerFactory.getLogger(ComponentesServiceImpl.class);
    private final ComponentesRepository entityRepository;
    private final ComponentesMapping entityMapping = Mappers.getMapper(ComponentesMapping.class);
     ...
     */
    public ComponentesServiceImpl(ComponentesRepository entityRepository) {
    ...
    public Page<ComponentesDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo Componentes con paginación");
     ...
     */
    @Override
    public ComponentesDTO saveUpdate(ComponentesDTO entityDTO) throws Exception {
        log.debug("Solicitud para guardar la entidad tipo Componentes: {}", entityDTO);

        //TODO: agregar validación específica del servicio.
        Componentes entity = entityMapping.getEntity(entityDTO);
        entity = entityRepository.save(entity);

        ComponentesDTO dto = entityMapping.getDto(entity);
        return dto;
    }
     ...
     */
    @Override
    public ComponentesDTO getEntity(String id) throws Exception {
    ...
    public void deleteEntity(String id) throws Exception {
        log.debug("Solicitud para eliminar la entidad tipo Componentes: {}", id);
