/*
 * @fileoverview    {MaterialesDatosCompraRest}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code MaterialesDatosCompraRest}.
 *
 * @author Dyson Parra
...
public class MaterialesDatosCompraRest {
    ...
    @GetMapping("/materiales-datos-compra")
    ...
    @GetMapping("/materiales-datos-compra/pages")
    public ResponseEntity<CollectionModel<EntityModel<MaterialesDatosCompraDTO>>> getAllEntitiesPaged(Pageable pageable) {
        ...
        try {
            ...
            HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/materiales-datos-compra/pages");
    ...
    @PostMapping("/materiales-datos-compra")
    ...
    @PutMapping("/materiales-datos-compra/{id}")
    ...
    @GetMapping("/materiales-datos-compra/{id}")
    ...
    @DeleteMapping("/materiales-datos-compra/{id}")
    ...
    @GetMapping("/materiales-datos-compra/search/{query}")
    ...
    @GetMapping("/materiales-datos-compra/search/{query}/pages")
    public ResponseEntity<CollectionModel<EntityModel<MaterialesDatosCompraDTO>>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
        ...
        try {
            ...
            HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/materiales-datos-compra/search/{query}/pages/" + query);
            entities = page.getContent().parallelStream()
                    .map(entityRestAssembler::toModel)
                    .collect(Collectors.toList());
            CollectionModel<EntityModel<MaterialesDatosCompraDTO>> entitiesCollection = new CollectionModel<>(entities);
