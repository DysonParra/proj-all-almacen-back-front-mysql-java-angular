/*
 * @overview        {InterlocutoresComercialesServiceImpl}
 *
 * @version         2.0
 *
...
public class InterlocutoresComercialesServiceImpl implements GenericService<InterlocutoresComercialesDTO> {
    ...
    public Page<InterlocutoresComercialesDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo InterlocutoresComerciales con paginación");
    ...
    public InterlocutoresComercialesDTO saveUpdate(InterlocutoresComercialesDTO entityDTO) throws Exception {
        ...
        InterlocutoresComercialesDTO dto = entityMapping.getDto(entity);
        return dto;
    }
