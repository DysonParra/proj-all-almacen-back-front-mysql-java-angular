/*
 * @overview        {MaterialesCostosPromediosServiceImpl}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code MaterialesCostosPromediosServiceImpl}.
 *
 * @author Dyson Parra
...
public class MaterialesCostosPromediosServiceImpl implements GenericService<MaterialesCostosPromediosDTO> {
    ...
    private final MaterialesCostosPromediosMapping entityMapping = Mappers.getMapper(MaterialesCostosPromediosMapping.class);
     ...
     */
    public MaterialesCostosPromediosServiceImpl(MaterialesCostosPromediosRepository entityRepository) {
    ...
    public Page<MaterialesCostosPromediosDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo MaterialesCostosPromedios con paginación");
     ...
     */
    @Override
    public MaterialesCostosPromediosDTO saveUpdate(MaterialesCostosPromediosDTO entityDTO) throws Exception {
        log.debug("Solicitud para guardar la entidad tipo MaterialesCostosPromedios: {}", entityDTO);

        //TODO: agregar validación específica del servicio.
        MaterialesCostosPromedios entity = entityMapping.getEntity(entityDTO);
        entity = entityRepository.save(entity);

        MaterialesCostosPromediosDTO dto = entityMapping.getDto(entity);
        return dto;
    }
     ...
     */
    @Override
    public MaterialesCostosPromediosDTO getEntity(String id) throws Exception {
    ...
    public void deleteEntity(String id) throws Exception {
        log.debug("Solicitud para eliminar la entidad tipo MaterialesCostosPromedios: {}", id);
