/*
 * @overview        {UbicacionesServiceImpl}
 *
 * @version         2.0
 *
...
import com.project.dev.api.repository.UbicacionesRepository;
import com.project.dev.api.service.GenericService;
import com.project.dev.api.service.exception.EntityNotFoundException;
import com.project.dev.api.service.mapping.UbicacionesMapping;
...
/**
 * TODO: Description of {@code UbicacionesServiceImpl}.
 *
 * @author Dyson Parra
...
public class UbicacionesServiceImpl implements GenericService<UbicacionesDTO> {

    private final Logger log = LoggerFactory.getLogger(UbicacionesServiceImpl.class);
    private final UbicacionesRepository entityRepository;
    private final UbicacionesMapping entityMapping = Mappers.getMapper(UbicacionesMapping.class);
     ...
     */
    public UbicacionesServiceImpl(UbicacionesRepository entityRepository) {
    ...
    public Page<UbicacionesDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo Ubicaciones con paginación");
     ...
     */
    @Override
    public UbicacionesDTO saveUpdate(UbicacionesDTO entityDTO) throws Exception {
        log.debug("Solicitud para guardar la entidad tipo Ubicaciones: {}", entityDTO);

        //TODO: agregar validación específica del servicio.
        Ubicaciones entity = entityMapping.getEntity(entityDTO);
        entity = entityRepository.save(entity);

        UbicacionesDTO dto = entityMapping.getDto(entity);
        return dto;
    }
     ...
     */
    @Override
    public UbicacionesDTO getEntity(String id) throws Exception {
    ...
    public void deleteEntity(String id) throws Exception {
        log.debug("Solicitud para eliminar la entidad tipo Ubicaciones: {}", id);
