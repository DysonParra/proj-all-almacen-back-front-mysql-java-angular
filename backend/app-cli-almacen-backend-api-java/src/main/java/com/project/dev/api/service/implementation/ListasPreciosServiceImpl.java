/*
 * @overview        {ListasPreciosServiceImpl}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code ListasPreciosServiceImpl}.
 *
 * @author Dyson Parra
...
public class ListasPreciosServiceImpl implements GenericService<ListasPreciosDTO> {
    ...
    public Page<ListasPreciosDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo ListasPrecios con paginación");
    ...
    public ListasPreciosDTO saveUpdate(ListasPreciosDTO entityDTO) throws Exception {
        ...
        ListasPreciosDTO dto = entityMapping.getDto(entity);
        return dto;
    }
