/*
 * @overview        {MaterialesDatosCompraServiceImpl}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code MaterialesDatosCompraServiceImpl}.
 *
 * @author Dyson Parra
...
public class MaterialesDatosCompraServiceImpl implements GenericService<MaterialesDatosCompraDTO> {
    ...
    public Page<MaterialesDatosCompraDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo MaterialesDatosCompra con paginación");
    ...
    public MaterialesDatosCompraDTO saveUpdate(MaterialesDatosCompraDTO entityDTO) throws Exception {
        ...
        MaterialesDatosCompraDTO dto = entityMapping.getDto(entity);
        return dto;
    }
